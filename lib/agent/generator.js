...
import { BANNED_AI_WORDS, buildUtmUrl } from './config';
...
`;
    ...
    try {
        ...
        // 3. Resolve Indie Hackers Data (Support all variations and formats)
        ...
        if (typeof ihData === 'string') {
            ...
            ihTitle = ihData.title || ihData.headline || ihData.subject || parsed.hook || `How we built a free ${tool.title} to drive traffic to LaunchXact`;
