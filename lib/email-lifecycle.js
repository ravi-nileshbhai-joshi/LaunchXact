...
export const LIFECYCLE_STEPS = [
    ...
    },
    {
        ...
        delayDays: 5,
        objective: 'Founding 50 applications are opening. The automated qualification CTA.',
        subject: (data) => `🚀 Founding 50 applications are open — claim your founder spot for ${data.idea_name || 'your tool'}`,
        preheader: (data) => `100% free permanent listing, The Vault backlinks, and manual founder curation. Only 50 vetted spots.`
    }
];
    ...
    switch (step) {
            ...
            contentHtml = `
              ...
              <div style="background: linear-gradient(135deg, rgba(99, 102, 241, 0.12), rgba(168, 85, 247, 0.08)); border: 1px solid rgba(99, 102, 241, 0.3); border-radius: 12px; padding: 20px; margin: 22px 0;">
                <div style="margin-bottom: 12px;">
                  <strong style="color: #ffffff;">🚀 Curated Discovery Pipeline:</strong>
                  <span style="color: #94a3b8; font-size: 13px;"> Direct discoverability to early adopters, builders, and active buyers searching for specialized software tools.</span>
                </div>
                <div style="margin-bottom: 12px;">
                  <strong style="color: #ffffff;">💎 100% Free Directory Listing:</strong>
                  <span style="color: #94a3b8; font-size: 13px;"> We never charge founders to list products. Keep 100% of your customer revenue.</span>
                </div>
                <div>
        ...
        case 4:
            ...
            contentHtml = `
              ...
              <p style="color: #cbd5e1; font-size: 14px; line-height: 1.6;">
                In 5 days, we are officially opening applications for the next Founding 50 cohort. We keep the cohort strictly capped at 50 founders to maintain individual attention.
              </p>
            ...
            contentHtml = `
              <div style="margin-bottom: 24px;">
                ...
                <h1 style="color: #ffffff; font-size: 25px; font-weight: 900; letter-spacing: -0.02em; margin: 18px 0 8px;">
                  Founding 50 applications are officially open 🚀
                </h1>
                <p style="color: #94a3b8; font-size: 14.5px; margin: 0;">
              ...
              <p style="color: #cbd5e1; font-size: 14.5px; line-height: 1.65;">
                We are opening doors for the curated <strong>Founding 50</strong>. This is not a passive forum or an expensive agency. It is an end-to-end launchpad built to give you the distribution and infrastructure you need to reach your first $10,000 MRR.
              </p>
              ...
              <div style="background: #090d16; border: 1px solid #1e293b; border-radius: 14px; padding: 24px; margin: 24px 0;">
                <div style="font-size: 15px; font-weight: 800; color: #ffffff; margin-bottom: 16px;">
                  What Founding 50 Founders Receive:
                </div>

                <div style="margin-bottom: 14px; padding-left: 10px; border-left: 3px solid #10b981;">
                  <strong style="color: #34d399; font-size: 14px;">1. 100% Free Lifetime Listing:</strong>
                  <div style="color: #cbd5e1; font-size: 13px; margin-top: 3px;">We never charge founders to list products. Keep 100% of your earnings with zero hidden listing costs.</div>
                </div>

                <div style="margin-bottom: 14px; padding-left: 10px; border-left: 3px solid #6366f1;">
                  <strong style="color: #818cf8; font-size: 14px;">2. Hand-Curated & Manually Tested:</strong>
                  <div style="color: #cbd5e1; font-size: 13px; margin-top: 3px;">Every submission is personally tested for market gap, competitive alternatives, and genuine problem-solving utility.</div>
                </div>

                <div style="margin-bottom: 14px; padding-left: 10px; border-left: 3px solid #a855f7;">
                  <strong style="color: #c084fc; font-size: 14px;">3. Permanent DoFollow Authority in The Vault:</strong>
                  <div style="color: #cbd5e1; font-size: 13px; margin-top: 3px;">Permanent high-trust backlink equity that boosts your organic domain rating and search engine indexing.</div>
                </div>
                ...
                <div style="padding-left: 10px; border-left: 3px solid #f59e0b;">
                  <strong style="color: #fbbf24; font-size: 14px;">5. Founding 50 Verified Trust Badge:</strong>
