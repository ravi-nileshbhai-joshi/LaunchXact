 ...
 * 
 * Defines the core tool intelligence, narrative angles, target founder personas,
 * and UTM campaign parameters for autonomous multi-channel distribution.
 */

const BASE_URL = 'https://www.launchxact.com';
...
/**
 * Generate fully attributed UTM URL for a given tool and platform
 */
function buildUtmUrl(tool, platform, angleId) {
