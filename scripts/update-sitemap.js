...
const staticRoutes = [
    ...
    { loc: '/tools/launch-checklist', priority: '0.9', changefreq: 'weekly' },
    { loc: '/tools/saas-seo-checker', priority: '0.9', changefreq: 'weekly' },
    { loc: '/tools/meta-generator', priority: '0.9', changefreq: 'weekly' },
    { loc: '/tools/schema-generator', priority: '0.9', changefreq: 'weekly' },
    { loc: '/tools/internal-link-planner', priority: '0.9', changefreq: 'weekly' },
    { loc: '/tools/ai-visibility-checker', priority: '0.9', changefreq: 'weekly' },
    { loc: '/tools/ai-mention-tracker', priority: '0.9', changefreq: 'weekly' },
    { loc: '/tools/saas-pricing-calculator', priority: '0.9', changefreq: 'weekly' },
