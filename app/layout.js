  ...
  '@graph': [
    ...
    },
    {
      ...
      hasPart: [
        {
          '@type': 'WebPage',
          '@id': 'https://www.launchxact.com/grade',
        ...
        {
          '@type': 'WebPage',
          '@id': 'https://www.launchxact.com/tools',
        ...
        {
          '@type': 'WebPage',
          '@id': 'https://www.launchxact.com/where-to-launch-saas',
        ...
        {
          '@type': 'WebPage',
          '@id': 'https://www.launchxact.com/articles',
        ...
        {
          '@type': 'WebPage',
          '@id': 'https://www.launchxact.com/about',
        ...
        {
          '@type': 'WebPage',
          '@id': 'https://www.launchxact.com/contact',
    ...
    },
    {
      ...
      '@id': 'https://www.launchxact.com/#nav-grade',
      name: 'Grade SaaS',
      description: 'AI SaaS Launch Readiness Grader',
      url: 'https://www.launchxact.com/grade',
    },
    {
      '@type': 'SiteNavigationElement',
      '@id': 'https://www.launchxact.com/#nav-tools',
      name: 'Tools',
      description: 'Founder Toolkit and SaaS Calculators',
      url: 'https://www.launchxact.com/tools',
    },
    {
      '@type': 'SiteNavigationElement',
      '@id': 'https://www.launchxact.com/#nav-where-to-launch',
      name: 'Where to Launch',
      description: 'Where to Launch SaaS Directory',
      url: 'https://www.launchxact.com/where-to-launch-saas',
    },
    {
      '@type': 'SiteNavigationElement',
      '@id': 'https://www.launchxact.com/#nav-articles',
      name: 'Articles',
      description: 'SaaS Traction & Distribution Articles',
      url: 'https://www.launchxact.com/articles',
    },
    {
      '@type': 'SiteNavigationElement',
      '@id': 'https://www.launchxact.com/#nav-about',
      name: 'About',
      description: 'About LaunchXact Mission',
      url: 'https://www.launchxact.com/about',
    },
    {
      '@type': 'SiteNavigationElement',
      '@id': 'https://www.launchxact.com/#nav-contact',
      name: 'Contact',
      description: 'Contact LaunchXact Team',
      url: 'https://www.launchxact.com/contact',
    },
  ],
};
